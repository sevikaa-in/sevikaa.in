...
import { Bell, CheckCircle2, AlertCircle, Calendar, Users, X, Info } from 'lucide-react-native';
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.heroCard}>
          <View style={styles.heroRow}>
            ...
            <View style={styles.heroTextCol}>
              ...
              <Text style={styles.heroSub}>Track job requisition status updates, applicant submissions &amp; gate passes.</Text>
            </View>
          </View>
        </View>
        ...
        {loading ? (
          ...
          <View style={styles.emptyCard}>
            ...
            <Text style={styles.emptySub}>You have zero unread notification alerts in your account.</Text>
          </View>
        ) : (
...
const styles = StyleSheet.create({
  ...
  markReadText: { fontSize: 11, fontWeight: '800', color: '#1A73E8' },
