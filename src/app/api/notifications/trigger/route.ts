...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  en: {
    ...
    job_changes_requested_sms: "Sevikaa Alert: Action required for your job post. Admin Feedback: '{note}'. Please update and resubmit: http://localhost:3000/employer/dashboard/jobs",
    job_changes_requested_email_sub: "Action Required: Sevikaa Job Requisition Feedback",
    job_changes_requested_email_body: "<h1>Action Required on Job Requisition</h1><p>Admin has reviewed your job posting and requested the following changes:</p><blockquote style='background:#fff3cd;padding:12px;border-left:4px solid #ffc107;'>{note}</blockquote><p><a href='http://localhost:3000/employer/dashboard/jobs'>Click here to update and resubmit your job posting</a>.</p>"
  },
  hi: {
    ...
    job_changes_requested_sms: "सेविका अलर्ट: आपकी नौकरी की आवश्यकता पर कार्रवाई आवश्यक है। एडमिन नोट: '{note}'। अपडेट करने के लिए लॉग इन करें: http://localhost:3000/employer/dashboard/jobs",
