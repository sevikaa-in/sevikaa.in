  ...
  const kpis = [
    {
      ...
      trendColor: stats.revenueGrowth >= 0 ? "text-emerald-500 bg-emerald-50" : "text-red-500 bg-red-50",
    ...
    },
    {
      ...
      trendColor: stats.platformGrowth >= 0 ? "text-emerald-500 bg-emerald-50" : "text-red-500 bg-red-50",
